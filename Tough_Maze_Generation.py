...
output_dir = 'perfect_hard_mazes_70_by_100'
...
for i in range(10):
    ...
    maze_save_path = os.path.join(output_dir, f'perfect_hard_mazes_70_by_100_{i+1:03d}.png')
    solution_save_path = os.path.join(output_dir, f'perfect_hard_solution_70_by_100_{i+1:03d}.png')
